#!/usr/bin/env python3
"""
Stress Level Prediction - Fast Execution Script
Auto-generated headless version of stress.ipynb for demonstration.
"""
...
print("="*60)
print("STRESS LEVEL PREDICTION - FAST EXECUTION")
print("="*60)
...
plt.ylabel('Actual')
plt.tight_layout()
plt.savefig(RESULTS_DIR/'stress_confusion_matrix.png', dpi=150)
plt.close()
print(f"✓ Saved confusion matrix to {RESULTS_DIR/'stress_confusion_matrix.png'}")
